function onCreate()
	...
	makeAnimatedLuaSprite('wacky animated icon lol what the fuck not clickbait 3 am', 'icons/NEW_ABOMINATION_HYPNO_ICON', getProperty('iconP2.x'), getProperty('iconP2.y'))
	addAnimationByPrefix('wacky animated icon lol what the fuck not clickbait 3 am', 'idle', 'ABOMINATION HYPNO ICON', 24, false)
...
function onUpdate(elapsed)
	...
	setProperty('wacky animated icon lol what the fuck not clickbait 3 am.y', getProperty('iconP2.y') - 30)
