...
local path = "characters/sleep/tv" --Add path to spritesheet and xml, good: characters/name, bad: mods/images/characters
local defx = -50 --X position of the character
local defy = 70 --Y position of the character
local singDuration = 0.7 --Type how long you want the character to sing default: 0.7 (seconds)
local playerScale = 0.9 --Scale of the player, default: 1
...
--Names
local playerName = "tv" --Add the name of your character here (optional)
local idleName = "idle0001" --Add the name of the idle position in the xml file
...
local noteTypeName1 = "GF Sing" --Add the name of the custom notetype, leave blank for normal note
local noteTypeName2 = "Duet_Note" --Add the name of the custom notetype, leave blank for normal note
