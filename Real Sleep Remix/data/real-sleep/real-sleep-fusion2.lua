...
local path = "characters/sleep/real_sleepRed" --Add path to spritesheet and xml, good: characters/name, bad: mods/images/characters
local defx = 1050 --X position of the character
...
--Names
local playerName = "fusion2" --Add the name of your character here (optional)
